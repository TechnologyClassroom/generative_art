...
parser.add_argument(
    "-f", "--format", help="image format to be converted to gif"
)
parser.add_argument(
    "-t",
    "--time",
    type=float,
    help="number of seconds to display single image",
)
...
image_files = [
    x for x in image_files if x.lower().endswith(args.format.lower())
]
